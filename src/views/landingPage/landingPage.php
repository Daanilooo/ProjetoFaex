        ...
        <main>
            <section class="hero">
                <div class="container">
                    <div>
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Crie e consulte receitas de forma facil</h1>
	                        <p class="hero-paragraph">Gerencie suas receitas de forma prática, em um único lugar.</p>
            ...
            <section class="features section">
                <div class="container">
                    <h3>Veja nossos ultimas receitas</h3>
					<div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            <?php foreach($reciepes as $key => $value): ?>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        <h4 class="feature-title mt-24"><?=  $value["date_receipes"] ?> | <?=  $value["name_scheduler"] ?></h4>
                        ...
                        <div class="btn-actions">
                            <a href="/panel/receipes/">Ver todos <span class="total-scheduler"></span> receitas</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Simplifique suas receitas com Filtros Inteligentes e Acompanhamento Completo</h2>
